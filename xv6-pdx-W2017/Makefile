...
# CFLAGS += -DCS333_P3P4         # CS333 to turn on the new scheduler. Added for Project 3: List Management
CFLAGS += -DCS333_P5 # Added for CS333 Project 5
...
# CHANGELOG: Added _date for Project 1: The date() System Call
#	     Added _testuidgid for Project 2: UIDs and PIDs and PPIDs
#	     Added _ps for Project 2: The "ps" Command
#	     Added _time for Project 2: The "time" Command
#	     Added _setpriority for Project 4: The setpriority() System Call
#	     Added _loopforever for Project 4 testing
UPROGS=\
	_cat\
	_echo\
	_forktest\
