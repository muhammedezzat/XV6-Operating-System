...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	0f b6 80 48 0a 00 00 	movzbl 0xa48(%eax),%eax
...
free(void *ap)
{
 ...
 5e2:	a1 64 0a 00 00       	mov    0xa64,%eax
...
free(void *ap)
{
 ...
 6ad:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 6b2:	90                   	nop
 6b3:	c9                   	leave  
 6b4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 70b:	83 c4 10             	add    $0x10,%esp
  return freep;
 70e:	a1 64 0a 00 00       	mov    0xa64,%eax
}
 713:	c9                   	leave  
 714:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 727:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 72a:	a1 64 0a 00 00       	mov    0xa64,%eax
 72f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 732:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 736:	75 23                	jne    75b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 738:	c7 45 f0 5c 0a 00 00 	movl   $0xa5c,-0x10(%ebp)
 73f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 742:	a3 64 0a 00 00       	mov    %eax,0xa64
 747:	a1 64 0a 00 00       	mov    0xa64,%eax
 74c:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    base.s.size = 0;
 751:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 758:	00 00 00 
  }
 ...
 7ae:	a3 64 0a 00 00       	mov    %eax,0xa64
      return (void*)(p + 1);
 ...
 7b9:	eb 3b                	jmp    7f6 <malloc+0xe1>
    ...
    if(p == freep)
 7bb:	a1 64 0a 00 00       	mov    0xa64,%eax
