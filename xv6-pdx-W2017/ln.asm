...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	0f b6 80 bc 0a 00 00 	movzbl 0xabc(%eax),%eax
...
free(void *ap)
{
 ...
 62a:	a1 d8 0a 00 00       	mov    0xad8,%eax
...
free(void *ap)
{
 ...
 6f5:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 6fa:	90                   	nop
 6fb:	c9                   	leave  
 6fc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 753:	83 c4 10             	add    $0x10,%esp
  return freep;
 756:	a1 d8 0a 00 00       	mov    0xad8,%eax
}
 75b:	c9                   	leave  
 75c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 76f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 772:	a1 d8 0a 00 00       	mov    0xad8,%eax
 777:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 77e:	75 23                	jne    7a3 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 780:	c7 45 f0 d0 0a 00 00 	movl   $0xad0,-0x10(%ebp)
 787:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78a:	a3 d8 0a 00 00       	mov    %eax,0xad8
 78f:	a1 d8 0a 00 00       	mov    0xad8,%eax
 794:	a3 d0 0a 00 00       	mov    %eax,0xad0
    base.s.size = 0;
 799:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 7a0:	00 00 00 
  }
 ...
 7f6:	a3 d8 0a 00 00       	mov    %eax,0xad8
      return (void*)(p + 1);
 ...
 801:	eb 3b                	jmp    83e <malloc+0xe1>
    ...
    if(p == freep)
 803:	a1 d8 0a 00 00       	mov    0xad8,%eax
