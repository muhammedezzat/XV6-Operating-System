...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 8a 03 00 00       	call   3dd <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e8:	0f b6 80 a8 0b 00 00 	movzbl 0xba8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 624:	75 25                	jne    64b <printf+0xff>
          s = "(null)";
 626:	c7 45 f4 35 09 00 00 	movl   $0x935,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ec:	a1 c4 0b 00 00       	mov    0xbc4,%eax
...
free(void *ap)
{
 ...
 7b7:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 7bc:	90                   	nop
 7bd:	c9                   	leave  
 7be:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 815:	83 c4 10             	add    $0x10,%esp
  return freep;
 818:	a1 c4 0b 00 00       	mov    0xbc4,%eax
}
 81d:	c9                   	leave  
 81e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 831:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 834:	a1 c4 0b 00 00       	mov    0xbc4,%eax
 839:	89 45 f0             	mov    %eax,-0x10(%ebp)
 83c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 840:	75 23                	jne    865 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 842:	c7 45 f0 bc 0b 00 00 	movl   $0xbbc,-0x10(%ebp)
 849:	8b 45 f0             	mov    -0x10(%ebp),%eax
 84c:	a3 c4 0b 00 00       	mov    %eax,0xbc4
 851:	a1 c4 0b 00 00       	mov    0xbc4,%eax
 856:	a3 bc 0b 00 00       	mov    %eax,0xbbc
    base.s.size = 0;
 85b:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 862:	00 00 00 
  }
 ...
 8b8:	a3 c4 0b 00 00       	mov    %eax,0xbc4
      return (void*)(p + 1);
 ...
 8c3:	eb 3b                	jmp    900 <malloc+0xe1>
    ...
    if(p == freep)
 8c5:	a1 c4 0b 00 00       	mov    0xbc4,%eax
