...
printint(int fd, int xx, int base, int sgn)
{
 ...
 56f:	0f b6 80 34 0c 00 00 	movzbl 0xc34(%eax),%eax
...
free(void *ap)
{
 ...
 773:	a1 68 0c 00 00       	mov    0xc68,%eax
...
free(void *ap)
{
 ...
 83e:	a3 68 0c 00 00       	mov    %eax,0xc68
}
 843:	90                   	nop
 844:	c9                   	leave  
 845:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 89c:	83 c4 10             	add    $0x10,%esp
  return freep;
 89f:	a1 68 0c 00 00       	mov    0xc68,%eax
}
 8a4:	c9                   	leave  
 8a5:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8b8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8bb:	a1 68 0c 00 00       	mov    0xc68,%eax
 8c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8c3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8c7:	75 23                	jne    8ec <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8c9:	c7 45 f0 60 0c 00 00 	movl   $0xc60,-0x10(%ebp)
 8d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8d3:	a3 68 0c 00 00       	mov    %eax,0xc68
 8d8:	a1 68 0c 00 00       	mov    0xc68,%eax
 8dd:	a3 60 0c 00 00       	mov    %eax,0xc60
    base.s.size = 0;
 8e2:	c7 05 64 0c 00 00 00 	movl   $0x0,0xc64
 8e9:	00 00 00 
  }
 ...
 93f:	a3 68 0c 00 00       	mov    %eax,0xc68
      return (void*)(p + 1);
 ...
 94a:	eb 3b                	jmp    987 <malloc+0xe1>
    ...
    if(p == freep)
 94c:	a1 68 0c 00 00       	mov    0xc68,%eax
